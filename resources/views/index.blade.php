                ...
                <div class="col-12 pt-4 px-0">
                    <div class="col-12 row px-0">
                        ...
                        <div class="col-12 row text-center d-inline px-0" style="margin-top: 15px">
                            <a target="_blank" href="https://dash.devlab.ae/terms_en" class="footer-link" style="margin-right: 20px; margin-left: 20px">Terms & Conditions</a>
                            <a target="_blank" href="https://dash.devlab.ae/policy_en" class="footer-link" style="margin-right: 20px; margin-left: 20px">Privacy</a>
                        </div>
                    </div>
                </div>
            </div>
