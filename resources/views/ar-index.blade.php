                ...
                <div class="col-12 pt-4 px-0">
                    <div class="col-12 row px-0">
                            ...
                            @foreach ($sites as $site)
                                <div class="d-inline-block" style="width: 112px;height: 91px;">
                                    <a href="{{$site->link}}" style="width: 100%;height: 91px;" class="d-block text-center">
                                        <img src="{{($site->site_profile && count($site->site_profile) > 0 && $site->site_profile[0]->icon_en) ? $site->site_profile[0]->icon_en : env('PUBLIC_PATH').'/brandmark-design.png' }}" style="width: 48px;height: 48px;object-fit: contain;" class="text-center d-inline-block my-2">
                        ...
                        <div class="col-12 row text-center d-inline px-0" style="margin-top: 20px">
                            <a href="https://dash.devlab.ae/terms" class="footer-link" style="margin-right: 20px; margin-left: 20px">الشروط والاحكام</a>
                            <a href="https://dash.devlab.ae/policy" class="footer-link" style="margin-right: 20px; margin-left: 20px">سياسة الخصوصية</a>
                        </div>
